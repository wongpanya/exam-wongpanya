...
const buildPrompt = (request) => {
    ...
    const system = [
        ...
        'For each rubric criterion, in "reason", provide a clear and structured explanation explaining:',
        '  - เหตุผลที่ให้คะแนน: จุดที่นักเรียนตอบได้ถูกต้อง ตรงประเด็น',
        '  - เหตุผลที่ตัดคะแนน: ประเด็นที่ขาดไป ไม่ครบถ้วน หรือไม่ถูกต้อง (หากไม่ได้คะแนนเต็ม)',
        '  - ความเหมาะสมของคะแนน: เหตุผลว่าทำไมคะแนนนี้ถึงยุติธรรมและเหมาะสมกับเกณฑ์ Rubric',
